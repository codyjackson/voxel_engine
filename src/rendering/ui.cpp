...
_browser("http://google.com", [](const CefRenderHandler::RectList&, const void*){})
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_BGRA_EXT, GL_UNSIGNED_BYTE, static_cast<void*>(_pixels.data()));
